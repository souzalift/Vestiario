    ...
    <footer className="bg-zinc-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">O Vestiário</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Sua loja especializada em camisas oficiais dos maiores clubes do
              mundo. Qualidade garantida e entrega rápida para todo o Brasil.
            </p>
        ...
        <div className="border-t border-gray-800 mt-4 flex flex-col md:flex-row justify-between items-center">
          <div className="flex mx-auto text-gray-400 text-sm md:mb-0 pt-2 text-center">
