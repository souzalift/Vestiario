              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    ou 3x de {formatPrice(calculateTotalPrice() / 3)} sem juros
                  </p>
                </div>
              </div>
                      ...
                      <div className="flex items-start gap-2 text-sm text-gray-700">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            ...
                            única. A taxa será cobrada apenas se você preencher
                            algum campo.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Estampa de alta qualidade que não desbota nem descola
                        </p>
                      </div>
                    </div>
                  </div>
